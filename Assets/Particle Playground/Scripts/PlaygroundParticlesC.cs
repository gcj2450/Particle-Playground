...
namespace ParticlePlayground
{
    ...
    public class PlaygroundParticlesC : MonoBehaviour
    {
		...
		*************************************************************************************************************************************************/
        ...
        /// <summary>
        /// Separate rotation axes determine if 2d- or 3d rotations will apply to the particles.
        /// </summary>
        [HideInInspector] public bool separateRotationAxes = false;
        /// <summary>
        /// Minimum initial 3d rotation using X,Y and Z axes. Note that separateRotationAxes needs to be enabled.
        /// </summary>
        [HideInInspector] public Vector3 initialRotationMin3d;
        /// <summary>
        /// Maximum initial 3d rotation using X,Y and Z axes. Note that separateRotationAxes needs to be enabled.
        /// </summary>
        [HideInInspector] public Vector3 initialRotationMax3d;
        /// <summary>
        ...
        /// <summary>
        /// Minimum amount to rotate a particle over time using X,Y and Z axes. Note that separateRotationAxes needs to be enabled.
        /// </summary>
        [HideInInspector] public Vector3 rotationSpeedMin3d;
        /// <summary>
        /// Maximum amount to rotate a particle over time using X,Y and Z axes. Note that separateRotationAxes needs to be enabled.
        /// </summary>
        [HideInInspector] public Vector3 rotationSpeedMax3d;
        /// <summary>
        ...
        /// <summary>
        /// Gets or sets the random seed of the particle system. 
        /// The seed is used to distribute all System Randoms of the particle system such as scatter positions, velocities and rotations.
        /// After setting the random seed you may also want to call RefreshRandomAll() on the particle system to rebuild all particle random values according to the seed.
        /// </summary>
        /// <value>The random seed of the particle system.</value>
        [HideInInspector]
        public int randomSeed
        {
            ...
            {
                _randomSeed = value;
                RefreshSystemRandom(_randomSeed);
            }
        }
        [SerializeField] private int _randomSeed;
        /// <summary>
        /// Determines if a random seed should be generated when the particle system enables.
        /// </summary>
        [HideInInspector] public bool randomSeedOnEnable = true;
        ...
        bool previousSeparateRotationAxes;
        Vector3 previousInitialRotationMin3d;
        Vector3 previousInitialRotationMax3d;
        Vector3 previousRotationSpeedMin3d;
        Vector3 previousRotationSpeedMax3d;
        ...
        ParticleSystem.MainModule shurikenMainModule;
#endif
		...
		*************************************************************************************************************************************************/
        ...
        public void CopyTo(PlaygroundParticlesC playgroundParticles)
        {
            ...
            playgroundParticles.separateRotationAxes = separateRotationAxes;
            playgroundParticles.initialRotationMin3d = initialRotationMin3d;
            playgroundParticles.initialRotationMax3d = initialRotationMax3d;
            playgroundParticles.rotationSpeedMin3d = rotationSpeedMin3d;
            playgroundParticles.rotationSpeedMax3d = rotationSpeedMax3d;
            ...
            // Seed
            playgroundParticles._randomSeed = _randomSeed;
            playgroundParticles.randomSeedOnEnable = randomSeedOnEnable;
        }
        ...
        /// <summary>
        /// Sets a new random seed for the internal System.Random.
        /// </summary>
        ...
        public void RefreshSystemRandom(int seed)
        {
            _randomSeed = seed;
            internalRandom01 = new System.Random(_randomSeed);
        }
        ...
        {
            RefreshSystemRandom(seed);
        }

        /// <summary>
        /// Refresh the random distribution for all particle sizes, initial rotations, rotation speeds, local- and global velocities.
        /// The passed in seed will determine the seed of the internal System Random and affects how all randoms are distributed.
        /// </summary>
        /// <param name="seed">Seed.</param>
        public void RefreshRandomAll(int seed)
        {
            RefreshSystemRandom(seed);
            RefreshRandomAll();
        }
        ...
        /// Refresh the random distribution for all particle sizes, initial rotations, rotation speeds, local- and global velocities.
        /// </summary>
        public void RefreshRandomAll()
        {
            RefreshScatter();
            RefreshRandomSizes();
            RefreshRandomInitialRotations();
            RefreshRandomRotationSpeeds();
            RefreshRandomLocalVelocities();
            RefreshRandomVelocities();
        }

        /// <summary>
        /// Refresh the random particle sizes.
        /// </summary>
        public void RefreshRandomSizes()
        {
            SetSizeRandom(thisInstance, sizeMin, sizeMax);
        }

        /// <summary>
        /// Refresh the random initial particle rotations. Note that the value of separateRotationAxes will determine which arrays will be changed.
        /// </summary>
        public void RefreshRandomInitialRotations()
        {
            if (separateRotationAxes)
                SetInitialRotationRandom(thisInstance, initialRotationMin3d, initialRotationMax3d);
            else
                SetInitialRotationRandom(thisInstance, initialRotationMin, initialRotationMax);
        }

        /// <summary>
        /// Refresh the random particle rotation speeds. Note that the value of separateRotationAxes will determine which arrays will be changed.
        /// </summary>
        public void RefreshRandomRotationSpeeds()
        {
            if (separateRotationAxes)
                SetRotationRandom(thisInstance, rotationSpeedMin3d, rotationSpeedMax3d);
            else
                SetRotationRandom(thisInstance, rotationSpeedMin, rotationSpeedMax);
        }

        /// <summary>
        /// Refresh the random local particle velocities.
        /// </summary>
        public void RefreshRandomLocalVelocities()
        {
            SetLocalVelocityRandom(thisInstance, initialLocalVelocityMin, initialLocalVelocityMax);
        }

        /// <summary>
        /// Refresh the random particle velocities.
        /// </summary>
        public void RefreshRandomVelocities()
        {
        ...
        public static void SetRotationRandom(PlaygroundParticlesC playgroundParticles, float rotationMinimum, float rotationMaximum)
        {
            ...
            if (playgroundParticles.playgroundCache.rotation == null || playgroundParticles.playgroundCache.rotation.Length != playgroundParticles.playgroundCache.rotationSpeed.Length)
                playgroundParticles.playgroundCache.rotation = new float[playgroundParticles.playgroundCache.rotationSpeed.Length];
            for (int i = 0; i < playgroundParticles.particleCache.Length; i++)
            {
        ...
        public static void SetInitialRotationRandom(PlaygroundParticlesC playgroundParticles, float rotationMinimum, float rotationMaximum)
        {
            ...
            if (playgroundParticles.playgroundCache.rotation == null || playgroundParticles.playgroundCache.rotation.Length != playgroundParticles.playgroundCache.initialRotation.Length)
                playgroundParticles.playgroundCache.rotation = new float[playgroundParticles.playgroundCache.initialRotation.Length];
            for (int i = 0; i < playgroundParticles.playgroundCache.initialRotation.Length; i++)
            {
                playgroundParticles.playgroundCache.rotation[i] = playgroundParticles.playgroundCache.initialRotation[i];
            }
        ...
        // Set random 3d rotation for particles within rotationMinimum- and rotationMaximum range
        public static void SetRotationRandom(PlaygroundParticlesC playgroundParticles, Vector3 rotationMinimum, Vector3 rotationMaximum)
        {
            playgroundParticles.playgroundCache.rotationSpeed3d = RandomVector3(playgroundParticles.particleCache.Length, rotationMinimum, rotationMaximum, playgroundParticles.internalRandom01);
            if (playgroundParticles.playgroundCache.rotation3d == null || playgroundParticles.playgroundCache.rotation3d.Length != playgroundParticles.playgroundCache.rotationSpeed3d.Length)
                playgroundParticles.playgroundCache.rotation3d = new Vector3[playgroundParticles.playgroundCache.initialRotation3d.Length];
            for (int i = 0; i < playgroundParticles.particleCache.Length; i++)
            {
                playgroundParticles.playgroundCache.rotation3d[i] = playgroundParticles.playgroundCache.initialRotation3d[i];
            }
            playgroundParticles.rotationSpeedMin3d = rotationMinimum;
            playgroundParticles.rotationSpeedMax3d = rotationMaximum;
            playgroundParticles.previousRotationSpeedMin3d = playgroundParticles.rotationSpeedMin3d;
            playgroundParticles.previousRotationSpeedMax3d = playgroundParticles.rotationSpeedMax3d;
        }

        // Set random initial 3d rotation for particles within rotationMinimum- and rotationMaximum range
        public static void SetInitialRotationRandom(PlaygroundParticlesC playgroundParticles, Vector3 rotationMinimum, Vector3 rotationMaximum)
        {
            playgroundParticles.playgroundCache.initialRotation3d = RandomVector3(playgroundParticles.particleCache.Length, rotationMinimum, rotationMaximum, playgroundParticles.internalRandom01);
            if (playgroundParticles.playgroundCache.rotation3d == null || playgroundParticles.playgroundCache.rotation3d.Length != playgroundParticles.playgroundCache.initialRotation3d.Length)
                playgroundParticles.playgroundCache.rotation3d = new Vector3[playgroundParticles.playgroundCache.initialRotation3d.Length];
            for (int i = 0; i < playgroundParticles.particleCache.Length; i++)
            {
                playgroundParticles.playgroundCache.rotation3d[i] = playgroundParticles.playgroundCache.initialRotation3d[i];
            }
            playgroundParticles.initialRotationMin3d = rotationMinimum;
            playgroundParticles.initialRotationMax3d = rotationMaximum;
            playgroundParticles.previousInitialRotationMin3d = playgroundParticles.initialRotationMin3d;
            playgroundParticles.previousInitialRotationMax3d = playgroundParticles.initialRotationMax3d;
        }
        ...
        public static void SetLifetimeSubtraction(PlaygroundParticlesC playgroundParticles)
        {
            ...
            System.Random random = playgroundParticles.internalRandom01;
        ...
        public static void SetParticleTimeNow(PlaygroundParticlesC playgroundParticles)
        {
            ...
            if (playgroundParticles.source != SOURCEC.Script)
            {
                ...
                if (currentTime <= 0) currentTime = playgroundParticles.localTime;
        ...
        static void SetParticleCountAsyncFriendly(PlaygroundParticlesC playgroundParticles, int amount)
        {
            ...
            if (!playgroundParticles.separateRotationAxes)
                playgroundParticles.playgroundCache.rotation = new float[amount];
            else
                playgroundParticles.playgroundCache.rotation3d = new Vector3[amount];
            ...
            {
                playgroundParticles.playgroundCache.initialRotation3d = RandomVector3(amount, playgroundParticles.initialRotationMin3d, playgroundParticles.initialRotationMax3d, playgroundParticles.internalRandom01);
                playgroundParticles.playgroundCache.rotationSpeed3d = RandomVector3(amount, playgroundParticles.rotationSpeedMin3d, playgroundParticles.rotationSpeedMax3d, playgroundParticles.internalRandom01);
            }
            playgroundParticles.previousInitialRotationMin = playgroundParticles.initialRotationMin;
            playgroundParticles.previousInitialRotationMax = playgroundParticles.initialRotationMax;
            playgroundParticles.previousRotationSpeedMin = playgroundParticles.rotationSpeedMin;
        ...
        public bool UpdateSystem()
        {
            ...
            // Particle rotation
            bool separateRotationAxesChanged = separateRotationAxes != previousSeparateRotationAxes;
            if (separateRotationAxes)
            {
                if (initialRotationMin3d != previousInitialRotationMin3d || initialRotationMax3d != previousInitialRotationMax3d || separateRotationAxesChanged)
                    SetInitialRotationRandom(thisInstance, initialRotationMin3d, initialRotationMax3d);
                if (rotationSpeedMin3d != previousRotationSpeedMin3d || rotationSpeedMax3d != previousRotationSpeedMax3d || separateRotationAxesChanged)
                    SetRotationRandom(thisInstance, rotationSpeedMin3d, rotationSpeedMax3d);
            }
            else
            {
                if (initialRotationMin != previousInitialRotationMin || initialRotationMax != previousInitialRotationMax || separateRotationAxesChanged)
                    SetInitialRotationRandom(thisInstance, initialRotationMin, initialRotationMax);
                if (rotationSpeedMin != previousRotationSpeedMin || rotationSpeedMax != previousRotationSpeedMax || separateRotationAxesChanged)
                    SetRotationRandom(thisInstance, rotationSpeedMin, rotationSpeedMax);
            }

            if (separateRotationAxesChanged)
            {
#if UNITY_5_5_OR_NEWER
                ParticleSystem.RotationOverLifetimeModule rotationOverLifetimeModule = shurikenParticleSystem.rotationOverLifetime;
                rotationOverLifetimeModule.separateAxes = separateRotationAxes;
#endif
                previousSeparateRotationAxes = separateRotationAxes;
            }
...
#if UNITY_5_5_OR_NEWER
                        if (separateRotationAxes)
                            particleCache[p].rotation3D = playgroundCache.rotation3d[p];
                        else
...
#if UNITY_5_5_OR_NEWER
            localSpace = shurikenMainModule.simulationSpace == ParticleSystemSimulationSpace.Local;
#else
                ...
                switch (source)
                {
                    ...
                    case SOURCEC.Projection:
                        if (projection.projectionTexture != null && projection.projectionTransform != null)
                        {
                            ...
                            {
#if UNITY_5_5_OR_NEWER
                                shurikenMainModule.simulationSpace = ParticleSystemSimulationSpace.World;
#else
        ...
        private System.Action _particleCalculationAction;

        private void ThreadedDelegate()
        {
            if (isDoneThread || !isReadyForThreadedCalculations)
                return;
        ...
        {
            if (playgroundParticles._particleCalculationAction == null)
                playgroundParticles._particleCalculationAction = playgroundParticles.ThreadedDelegate;
            if (playgroundParticles.isDoneThread && playgroundParticles.isReadyForThreadedCalculations && !playgroundParticles.IsYieldRefreshing())
            {
                ...
                PlaygroundC.RunAsync(playgroundParticles._particleCalculationAction);
            }
        }
        ...
        public static void NewCalculatedThread(PlaygroundParticlesC[] playgroundParticles)
        {
            ...
            {
                if (playgroundParticles[i]._particleCalculationAction == null)
                    playgroundParticles[i]._particleCalculationAction = playgroundParticles[i].ThreadedDelegate;
                ...
                {
                    PlaygroundC.RunAsync(playgroundParticles[i]._particleCalculationAction);
                }
            }
        }
            ...
            if (!playgroundCache.changedByPropertyColor[p] && !playgroundCache.changedByPropertyColorLerp[p])
            {
                switch (colorSource)
                {
                    ...
                    case COLORSOURCEC.LifetimeColors:
                        ...
                        {
                            float ttime = 0;
                            if (float.IsNaN(normalizedLife))
                            {
                                normalizedLife = 1;
                            }
                            ttime = colorMethod == COLORMETHOD.Lifetime ? normalizedLife : normalizedP;
                            if (float.IsNaN(ttime))
                            {
                                ttime = 1;
                            }
                            currentColor = lifetimeColors[playgroundCache.lifetimeColorId[p] % lifetimeColors.Count].gradient.Evaluate(Mathf.Clamp01(ttime));
                        }
                        else
                            currentColor = lifetimeColor.Evaluate(colorMethod == COLORMETHOD.Lifetime ? normalizedLife : normalizedP);
                        break;
        ...
        public static void ThreadedCalculations(PlaygroundParticlesC playgroundParticles)
        {
            ...
            if (!playgroundParticles.separateRotationAxes)
            {
                if (playgroundParticles.playgroundCache.initialRotation == null || playgroundParticles.playgroundCache.initialRotation.Length != pCount)
                    playgroundParticles.playgroundCache.initialRotation = new float[pCount];
                if (playgroundParticles.playgroundCache.rotation == null || playgroundParticles.playgroundCache.rotation.Length != pCount)
                    playgroundParticles.playgroundCache.rotation = new float[pCount];
                if (playgroundParticles.playgroundCache.rotationSpeed == null || playgroundParticles.playgroundCache.rotationSpeed.Length != pCount)
                    playgroundParticles.playgroundCache.rotationSpeed = new float[pCount];
            }
            else
            {
                if (playgroundParticles.playgroundCache.initialRotation3d == null || playgroundParticles.playgroundCache.initialRotation3d.Length != pCount)
                    playgroundParticles.playgroundCache.initialRotation3d = new Vector3[pCount];
                if (playgroundParticles.playgroundCache.rotation3d == null || playgroundParticles.playgroundCache.rotation3d.Length != pCount)
                    playgroundParticles.playgroundCache.rotation3d = new Vector3[pCount];
                if (playgroundParticles.playgroundCache.rotationSpeed3d == null || playgroundParticles.playgroundCache.rotationSpeed3d.Length != pCount)
                    playgroundParticles.playgroundCache.rotationSpeed3d = new Vector3[pCount];
            }
            ...
            for (int p = 0; p < playgroundParticles.particleCount; p++)
            {
                ...
                float normalizedLife = playgroundParticles.lifetime > 0 ? Mathf.Clamp01(playgroundParticles.playgroundCache.life[p] / lifeInSeconds) : 0;
                ...
                Color32 lifetimeColor = playgroundParticles.GetParticleColor(p, Mathf.Clamp01(normalizedLife), normalizedP);
                ...
                if (playgroundParticles.playgroundCache.rebirth[p])
                {
                    ...
                    if (playgroundParticles.playgroundCache.birth[p] + playgroundParticles.playgroundCache.life[p] <= playgroundParticles.localTime + lifeInSeconds && (!playgroundParticles.playgroundCache.isNonBirthed[p] || playgroundParticles.onlyLifetimePositioning || playgroundParticles.onlySourcePositioning))
                    {
                        ...
                        if (t != 0)
                        {
                            if (playgroundParticles.separateRotationAxes)
                            {
                                playgroundParticles.playgroundCache.rotation3d[p] += playgroundParticles.playgroundCache.rotationSpeed3d[p] * t;
                            }
                            else
                            {
...
#if UNITY_5_5_OR_NEWER
                            if (playgroundParticles.separateRotationAxes)
                                playgroundParticles.particleCache[p].rotation3D = playgroundParticles.playgroundCache.rotation3d[p];
                            else
        ...
        {
            System.Random random = internalRandom01;
            for (int p = 0; p < particleCount; p++)
            {
                if (applySourceScatter)
                {
        ...
        // Returns a Vector3 array with random values between negative- and positive Vector3
        public static Vector3[] RandomVector3(int length, Vector3 v1, Vector3 v2, System.Random random)
        {
            Vector3[] v3arr = new Vector3[length];
            for (int i = 0; i < length; i++)
                v3arr[i] = RandomRange(random, v1, v2);
            return v3arr;
        }
        ...
        public static void Rebirth(PlaygroundParticlesC playgroundParticles, int p, System.Random random)
        {
            ...
            if (playgroundParticles.applyRandomRotationOnRebirth)
            {
                if (playgroundParticles.separateRotationAxes)
                {
                    playgroundParticles.playgroundCache.initialRotation3d[p] = RandomVector3(random, playgroundParticles.initialRotationMin3d, playgroundParticles.initialRotationMax3d);
                    playgroundParticles.playgroundCache.rotationSpeed3d[p] = RandomVector3(random, playgroundParticles.rotationSpeedMin3d, playgroundParticles.rotationSpeedMax3d);
                }
                else if (!playgroundParticles.rotateTowardsDirection)
                {
                    ...
                    playgroundParticles.playgroundCache.rotationSpeed[p] = RandomRange(random, playgroundParticles.rotationSpeedMin, playgroundParticles.rotationSpeedMax);
                }
            }
            ...
            {
#if UNITY_5_5_OR_NEWER
                playgroundParticles.playgroundCache.rotation3d[p] = playgroundParticles.playgroundCache.initialRotation3d[p];
                if (!playgroundParticles.syncPositionsOnMainThread)
                    playgroundParticles.particleCache[p].rotation3D = playgroundParticles.playgroundCache.rotation3d[p];
#else
				playgroundParticles.separateRotationAxes = false;
#endif
            }
            else
            {
        ...
        void SendEvent(EVENTTYPEC eventType, int p, Vector3 preEventVelocity, Transform collisionTransform, Collider collisionCollider, Collider2D collisionCollider2D)
        {
            ...
            for (int i = 0; i < events.Count; i++)
            {
                if (events[i].enabled && events[i].eventType == eventType)
                {
                    ...
                    PlaygroundEventC thisEvent = events[i];

                    // Check thresholds
                    if (thisEvent.eventType == EVENTTYPEC.Collision)
                        if (thisEvent.collisionThreshold > preEventVelocity.sqrMagnitude)
                            return;

                    // Set event position
                    switch (thisEvent.eventInheritancePosition)
                    {
                        case EVENTINHERITANCEC.User:
                            eventPosition = thisEvent.eventPosition;
                            break;
                    ...
                    // Set event velocity
                    switch (thisEvent.eventInheritanceVelocity)
                    {
                        case EVENTINHERITANCEC.User:
                            if (thisEvent.eventEmitCount == 1)
                            {
                                if (thisEvent.velocityValueMethod == VALUEMETHOD.Constant)
                                {
                                    eventVelocity = thisEvent.eventVelocity;
                                }
                                else
                                {
                                    // Create a random velocity for the event
                                    if (thisEvent.velocityRandomMethod == MINMAXVECTOR3METHOD.Spherical)
                                        eventVelocity = RandomRangeSpherical(internalRandom01, thisEvent.eventVelocityMin.x, thisEvent.eventVelocity.x);
                                    else if (thisEvent.velocityRandomMethod == MINMAXVECTOR3METHOD.SphericalLinear)
                                        eventVelocity = RandomRangeSpherical(internalRandom01, thisEvent.eventVelocityMin.x, thisEvent.eventVelocity.x, (p * 1f) / (particleCount * 1f));
                                    else if (thisEvent.velocityRandomMethod == MINMAXVECTOR3METHOD.RectangularLinear)
                                        eventVelocity = Vector3.Lerp(thisEvent.eventVelocityMin, thisEvent.eventVelocity, (p * 1f) / (particleCount * 1f));
                                    else eventVelocity = RandomRange(internalRandom01, thisEvent.eventVelocityMin, thisEvent.eventVelocity);
                                }
                            }
                            break;
                        case EVENTINHERITANCEC.Particle:
                    ...
                    // Apply multiplier
                    eventVelocity *= thisEvent.velocityMultiplier;

                    // Set event color
                    switch (thisEvent.eventInheritanceColor)
                    {
                        case EVENTINHERITANCEC.User:
                            eventColor = thisEvent.eventColor;
                            break;
                        case EVENTINHERITANCEC.Particle:
                    ...
                    if (thisEvent.broadcastType == EVENTBROADCASTC.EventListeners || thisEvent.broadcastType == EVENTBROADCASTC.Both)
                    {
                        ...
                        thisEvent.SendParticleEvent(eventParticle);

                        // Send the event to the Playground Manager
                        if (thisEvent.sendToManager)
                        {
                    ...
                    if (thisEvent.initializedTarget && (thisEvent.broadcastType == EVENTBROADCASTC.Target || thisEvent.broadcastType == EVENTBROADCASTC.Both))
                    {
                        int emitCount = thisEvent.eventEmitCount;

                        if (emitCount == 1)
                            thisEvent.target.ThreadSafeEmit(eventPosition, eventVelocity, eventColor);
                        else
                        {
                            for (int x = 0; x < emitCount; x++)
                            {
                                // Create a random velocity for the event
                                if (thisEvent.velocityRandomMethod == MINMAXVECTOR3METHOD.Spherical)
                                    eventVelocity = RandomRangeSpherical(internalRandom01, thisEvent.eventVelocityMin.x, thisEvent.eventVelocity.x);
                                else if (thisEvent.velocityRandomMethod == MINMAXVECTOR3METHOD.SphericalLinear)
                                    eventVelocity = RandomRangeSpherical(internalRandom01, thisEvent.eventVelocityMin.x, thisEvent.eventVelocity.x, (x * 1f) / (emitCount * 1f));
                                else if (thisEvent.velocityRandomMethod == MINMAXVECTOR3METHOD.RectangularLinear)
                                    eventVelocity = Vector3.Lerp(thisEvent.eventVelocityMin, thisEvent.eventVelocity, (x * 1f) / (emitCount * 1f));
                                else eventVelocity = RandomRange(internalRandom01, thisEvent.eventVelocityMin, thisEvent.eventVelocity);

                                // Apply multiplier
                                eventVelocity *= thisEvent.velocityMultiplier;

                                // Emit onto the target particle system
                                thisEvent.target.ThreadSafeEmit(eventPosition, eventVelocity, eventColor);
                            }
                        }
                    }
        ...
        public bool UpdateEventParticle(PlaygroundEventParticle eParticle, int p)
        {
            ...
            eParticle.initialRotation = !separateRotationAxes ? playgroundCache.initialRotation[p] : 0;
            eParticle.initialRotation3d = separateRotationAxes ? playgroundCache.initialRotation3d[p] : Vector3.zero;
            ...
            eParticle.rotation = !separateRotationAxes ? playgroundCache.rotation[p] : 0;
            eParticle.rotation3d = separateRotationAxes ? playgroundCache.rotation3d[p] : Vector3.zero;
            eParticle.rotationSpeed = !separateRotationAxes ? playgroundCache.rotationSpeed[p] : 0;
            eParticle.rotationSpeed3d = separateRotationAxes ? playgroundCache.rotationSpeed3d[p] : Vector3.zero;
...
#if UNITY_5_5_OR_NEWER
                shurikenMainModule = shurikenParticleSystem.main;
#endif
            }
        }
        ...
        IEnumerator Prewarm(float time, int resolution)
        {
            ...
            if (isReadyForThreadedCalculations)
            {
                ...
                if (sorting == SORTINGC.NearestNeighbor || sorting == SORTINGC.NearestNeighborReversed)
                {
                    ...
                    {
                        nearestNeighborOriginTransformPosition = !localSpace ?
        ...
        void OnEnable()
        {
            ...
            // Set new randoms if needed
            if (internalRandom01 == null || randomSeedOnEnable)
            {
                if (randomSeedOnEnable)
                    _randomSeed = UnityEngine.Random.Range(0, 10000);
                RefreshSystemRandom(_randomSeed);
            }

            // Set 0 size to avoid one-frame flash
#if UNITY_5_5_OR_NEWER
            if (shurikenParticleSystem == null)
                shurikenParticleSystem = GetComponent<ParticleSystem>();
            shurikenMainModule = shurikenParticleSystem.main;
            shurikenMainModule.startSizeMultiplier = 0;
#else
    ...
    public class PlaygroundEventParticle
    {
        ...
        /// <summary>
        /// The rotation in X, Y and Z axes of this particle.
        /// </summary>
        [HideInInspector] public Vector3 rotation3d;
        /// <summary>
        ...
        /// <summary>
        /// The initial rotation in X, Y and Z axes of this particle.
        /// </summary>
        [HideInInspector] public Vector3 initialRotation3d;
        /// <summary>
        /// The rotation speed of this particle.
        /// </summary>
        [HideInInspector] public float rotationSpeed;
        /// <summary>
        /// The rotation speed on X, Y and Z axes of this particle.
        /// </summary>
        [HideInInspector] public Vector3 rotationSpeed3d;
        /// <summary>
        ...
        public PlaygroundEventParticle Clone()
        {
            ...
            playgroundEventParticle.rotation3d = rotation3d;
            ...
            playgroundEventParticle.initialRotation3d = initialRotation3d;
            playgroundEventParticle.rotationSpeed = rotationSpeed;
            playgroundEventParticle.rotationSpeed3d = rotationSpeed3d;
    ...
    public class PlaygroundCache
    {
        ...
        [HideInInspector] public float[] rotation;
        /// <summary>
        /// The 3d rotation of each particle (X,Y and Z axes).
        /// </summary>
        [HideInInspector] public Vector3[] rotation3d;
        /// <summary>
        ...
        [HideInInspector] public float[] rotationSpeed;
        /// <summary>
        /// The initial 3d rotation of each particle.
        /// </summary>
        [HideInInspector] public Vector3[] initialRotation3d;
        /// <summary>
        /// The rotation speed in 3d of each particle.
        /// </summary>
        [HideInInspector] public Vector3[] rotationSpeed3d;
        /// <summary>
